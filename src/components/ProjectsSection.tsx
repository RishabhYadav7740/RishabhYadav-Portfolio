const projects = [
  {
    title: "SOFT",
    description: "A Python-based software project showcasing data processing and analysis capabilities.",
    tech: ["Python"],
    github: "https://github.com/RishabhYadav7740/SOFT",
  },
  {
    title: "Project A",
    description: "A JavaScript application exploring interactive web-based solutions.",
    tech: ["JavaScript"],
    github: "https://github.com/RishabhYadav7740/A",
  },
];
